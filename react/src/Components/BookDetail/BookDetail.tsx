...
export const BookCheckout = () => {
    ...
    const [userReviewPresent, setUserReviewPresent] = useState<ReviewModel[]>([]);
    ...
    async function deleteReview(id: number) {
        const url = `http://localhost:8080/api/reviews/secure/deleteReview/${id}`;
        console.log(url);
        const requestOptions = {
            method: "Delete",
            headers: {
        ...
        setUserReviewDeleted(!userReviewDeleted);
    }
    ...
    return (
        <div>
            <div className="container d-none d-lg-block">
                ...
                <hr/>
                <Reviews reviews={reviews} mobile={false} userReview={userReviewPresent} deleteReview={deleteReview}/>
            </div>
            <div className="container d-lg-none mt-5">
                ...
                <CheckoutAndReviewBox
                    ...
                    submitReview={submitReview}/>
                <hr/>
                <Reviews reviews={reviews} userReview={userReviewPresent} mobile={true} deleteReview={deleteReview}/>
