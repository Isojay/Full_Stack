            ...
            {books && books.length === 0 ?
                <div className="container mt-5 text-center">
                    <div className="alert alert-warning" role="alert">
                        <h4 className="alert-heading">No Books Found</h4>
                        <p>Unfortunately, there are no books available at the moment.</p>
                        <hr/>
                        <p className="mb-0">Please check back later or explore other sections.</p>
                    </div>
                </div>
                :
