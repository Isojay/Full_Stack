...
export const BookCheckout = () => {
    ...
    if (isLoading || isReviewLoading || isUserLoanLoading || isCheckedOutLoading) {
        ...
        <div>
            <div className="container d-none d-lg-block">
                <div className="row mt-5">
                    ...
                    <CheckoutAndReviewBox book={book} mobile={false} userLoan={userLoan}
                                          checkOutCondition={isCheckedOut} isAuthenticated={authState?.isAuthenticated}
            ...
            <div className="container d-lg-none mt-5">
                ...
                <CheckoutAndReviewBox book={book} mobile={true} userLoan={userLoan} checkOutCondition={isCheckedOut}
